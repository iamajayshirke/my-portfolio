      ...
      <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="space-y-4">
          <p className="text-xl md:text-2xl text-[var(--text-sec)] max-w-2xl leading-relaxed">
            ...
            experience building high-performance web applications and robust
            full-stack solutions.
          </p>

          {/* AI Build & Deployment Milestone */}
        ...
        <div className="flex gap-4 pt-4">
          ...
          <a
            href="https://wa.me/918169178869?text=Hi%20Ajay,%20I%20saw%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20Software%20Engineering%20opportunity."
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-3 px-8 py-5 font-extrabold rounded-2xl transition-all hover:scale-105 shadow-xl
               bg-[#25D366] text-white hover:bg-[#20ba5a] border border-[#25D366]/20"
          >
            <svg
              viewBox="0 0 24 24"
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-lg max-w-xl leading-relaxed text-[var(--main-text)] opacity-90">
              I'm currently open to new roles in Software Engineering and
              Full-stack development. Let's discuss how my 4 years of experience
              can help your team.
            </p>
